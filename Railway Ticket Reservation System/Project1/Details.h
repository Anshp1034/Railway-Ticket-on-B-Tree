...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->splitContainer1->Size = System::Drawing::Size(1864, 782);
			...
			this->splitContainer3->Margin = System::Windows::Forms::Padding(1, 2, 2, 5);
			...
			this->splitContainer3->Panel2->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Details::splitContainer3_Panel2_Paint);
			this->splitContainer3->Size = System::Drawing::Size(1864, 394);
			...
			this->label3->Location = System::Drawing::Point(321, 195);
			this->label3->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(203, 47);
			...
			this->label2->Location = System::Drawing::Point(321, 143);
			this->label2->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(258, 47);
			...
			this->label1->Location = System::Drawing::Point(321, 95);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(253, 47);
			...
			this->pictureBox1->Location = System::Drawing::Point(42, 45);
			this->pictureBox1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(244, 297);
			...
			this->label6->Location = System::Drawing::Point(282, 195);
			this->label6->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(218, 47);
			...
			this->label5->Location = System::Drawing::Point(288, 143);
			this->label5->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(212, 47);
			...
			this->label4->Location = System::Drawing::Point(282, 95);
			this->label4->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(118, 47);
			this->label4->TabIndex = 1;
			this->label4->Text = L"BNM";
			this->label4->Click += gcnew System::EventHandler(this, &Details::label4_Click);
			// 
			// pictureBox2
			// 
			this->pictureBox2->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox2.Image")));
			this->pictureBox2->Location = System::Drawing::Point(54, 45);
			this->pictureBox2->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(206, 297);
			...
			this->splitContainer2->Size = System::Drawing::Size(1864, 382);
			...
			this->label10->Location = System::Drawing::Point(464, 120);
			this->label10->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label10->Name = L"label10";
			this->label10->Size = System::Drawing::Size(662, 36);
			...
			this->label9->Location = System::Drawing::Point(357, 51);
			this->label9->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(1001, 36);
			this->label9->TabIndex = 2;
			this->label9->Text = L"FILE STRUCTURES LABORATORY WITH MINI PROJECT (18ISL67)";
			// 
			// label8
			// 
			...
			this->label8->Location = System::Drawing::Point(162, 120);
			this->label8->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(299, 36);
			...
			this->label7->Location = System::Drawing::Point(162, 51);
			this->label7->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(188, 36);
			...
			this->label14->Location = System::Drawing::Point(326, 145);
			this->label14->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label14->Name = L"label14";
			this->label14->Size = System::Drawing::Size(0, 36);
			...
			this->label13->Location = System::Drawing::Point(326, 62);
			this->label13->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label13->Name = L"label13";
			this->label13->Size = System::Drawing::Size(0, 36);
			...
			this->label12->Location = System::Drawing::Point(164, 145);
			this->label12->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label12->Name = L"label12";
			this->label12->Size = System::Drawing::Size(0, 36);
			...
			this->label11->Location = System::Drawing::Point(164, 62);
			...
			this->ClientSize = System::Drawing::Size(1864, 782);
